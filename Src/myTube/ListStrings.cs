...
namespace myTube
{
  ...
  {
    public static DependencyProperty DefaultProperty = DependencyProperty.Register(nameof (Default),
        typeof (string), typeof (ListStrings), new PropertyMetadata((object) null, 
            new PropertyChangedCallback(ListStrings.OnDefaultChanged)));

    public static DependencyProperty SignInProperty = DependencyProperty.Register(nameof (SignIn), 
        typeof (string), typeof (ListStrings), new PropertyMetadata((object) null, 
            new PropertyChangedCallback(ListStrings.OnSignInChanged)));

    public static DependencyProperty LoadingProperty = DependencyProperty.Register(nameof (Loading),
        typeof (string), typeof (ListStrings), new PropertyMetadata((object) null, 
            new PropertyChangedCallback(ListStrings.OnLoadingChanged)));

    public static DependencyProperty NoItemsProperty = DependencyProperty.Register(nameof (NoItems),
        typeof (string), typeof (ListStrings), new PropertyMetadata((object) null, 
            new PropertyChangedCallback(ListStrings.OnNoItemsChanged)));

    public static DependencyProperty CurrentProperty = DependencyProperty.Register(nameof (Current),
        typeof (string), typeof (ListStrings), new PropertyMetadata((object) null));
    public static DependencyProperty StateProperty = DependencyProperty.Register(nameof (State), 
        typeof (ListState), typeof (ListStrings), 
        new PropertyMetadata((object) ListState.Default, 
        new PropertyChangedCallback(ListStrings.OnStatePropertyChanged)));

    private static void OnDefaultChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
    {
        ListStrings.changed(d, e, ListState.Default);
    }

    private static void OnSignInChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
    {
        ListStrings.changed(d, e, ListState.SignIn);
    }

    private static void OnLoadingChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
    {
        ListStrings.changed(d, e, ListState.Loading);
    }

    private static void OnNoItemsChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
    {
        ListStrings.changed(d, e, ListState.NoItems);
    }
