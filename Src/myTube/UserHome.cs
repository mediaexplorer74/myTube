  ...
  public sealed partial class UserHome : UserControl
  {
    ...
    private void UserHome_Unloaded(object sender, RoutedEventArgs e)
    {
      ...
      YouTube.SignedOut -= new EventHandler<SignedOutEventArgs>(this.YouTube_SignedOut);
        ...
        private void YouTube_SigningIn(object sender, EventArgs e)
        {
           // ((DependencyObject)this).Dispatcher.RunAsync((CoreDispatcherPriority)0, 
           //     new DispatchedHandler((object)this, __methodptr(\u003CYouTube_SigningIn\u003Eb__4_0)));
        }
        ...
        private void UserHome_Loaded(object sender, RoutedEventArgs e)
    {
      ...
      YouTube.SignedOut += new EventHandler<SignedOutEventArgs>(this.YouTube_SignedOut);
        ...
        private async void YouTube_SignedOut(object sender, EventArgs e)
        {
            ...
            //            new DispatchedHandler((object)this, __methodptr(\u003CYouTube_SignedOut\u003Eb__6_0)));
        }

        private async void YouTube_SignedIn(object sender, EventArgs e)
        {
            //await ((DependencyObject)this).Dispatcher.RunAsync((CoreDispatcherPriority)0,
            //            new DispatchedHandler((object)this, __methodptr(\u003CYouTube_SignedIn\u003Eb__7_0)));
        }
        ...
        private void signInPanel_Tapped(object sender, TappedRoutedEventArgs e)
    {
      ...
      else
      {
        ...
        //popup1.Child=((UIElement) control);
        ...
        DefaultPage.SetPopupArrangeMethod((DependencyObject) popup2, (Func<Point>) (() =>
        {
          ...
          ((FrameworkElement) control).Width=(Math.Min(bounds1.Width, bounds2.Width - 38.0));
          ((FrameworkElement) control).MaxHeight=(Math.Min(400.0, bounds2.Height));
          return new Point()
          {
