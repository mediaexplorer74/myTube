...
using myTube.myTube_WindowsPhone_XamlTypeInfo;
using myTube.Popups;
...
namespace myTube
{
  public sealed class App : Application, IComponentConnector, IXamlMetadataProvider
  {
    ...
    public static DeviceFamily DeviceFamily => DeviceFamily.Mobile;

    public CustomFrame RootFrame => this.rootFrame;

    public static PlatformType PlatformType => PlatformType.WindowsPhone;
    ...
    public static YouTubeQuality HighestQuality
    {
      get
      {
        ...
        double num = Math.Min(Window.Current.Bounds.Width * forCurrentView.RawPixelsPerViewPixel, Window.Current.Bounds.Height * forCurrentView.RawPixelsPerViewPixel);
        if (num >= 1540.0)
          return YouTubeQuality.HD2160;
        if (num >= 1100.0)
    ...
    public static string FullDeviceName => App.DeviceFamily == DeviceFamily.Desktop ? "Windows Device" : App.DeviceManufacturer + " " + App.DeviceName;
    ...
    public static GlobalObjects GlobalObjects
    {
      get
      {
        if (App.gObjects == null)
          App.gObjects = ((IDictionary<object, object>) Application.Current.Resources)[(object) "GlobalAppObjects"] as GlobalObjects;
        return App.gObjects;
      }
    }

    public static Strings Strings => ((IDictionary<object, object>) Application.Current.Resources)[(object) nameof (Strings)] as Strings;

    public static ElementTheme OppositeTheme => Settings.Theme == 2 ? (ElementTheme) 1 : (ElementTheme) 2;

    public static ElementTheme Theme => Settings.Theme;
    ...
    public static bool IsTrial
    {
      get
      {
        try
        {
          return Settings.UserMode < UserMode.Owner && string.IsNullOrWhiteSpace(Settings.ProductKey) && !Settings.WasPaidFor && CurrentApp.LicenseInformation.IsTrial;
        }
        catch
        {
          return false;
    ...
    public App()
    {
      ...
      Helper.Write((object) nameof (App), (object) "App events registered");
      Helper.Write((object) nameof (App), (object) "Registered app events");
      YouTube.GetFilterMethod = (Func<IHttpFilter>) (() =>
      {
        HttpBaseProtocolFilter baseProtocolFilter = new HttpBaseProtocolFilter();
        baseProtocolFilter.put_MaxConnectionsPerServer(128U);
        baseProtocolFilter.put_AutomaticDecompression(true);
        baseProtocolFilter.put_UseProxy(false);
        return (IHttpFilter) baseProtocolFilter;
      });
      YouTube.ClientID = "424014257505-067odu7bdq7gg0dj7tvm1jkp7vf8ng9i.apps.googleusercontent.com";
      YouTube.DeveloperKey = "AI39si6dXEJmpguaJJhUrdMQhjP-MTkCM8Nj1SZrHlRdRP_jq25wIBzK5TAHpdyh7woySA6kOVjJ9r80uiL9jU4Gnnx3KE499w";
      YouTube.RedirectUri = "urn:ietf:wg:oauth:2.0:oob";
      YouTube.ClientSecret = "l0ExNytvMCAuN0QJ0MnsI0_m";
    ...
    public void InitialThemeSetup()
    {
      ...
      if (!((IDictionary<object, object>) themeDictionary1).ContainsKey((object) "AccentBrush") && !((IDictionary<object, object>) themeDictionary1).ContainsKey((object) "MenuBackground"))
      {
        ((IDictionary<object, object>) themeDictionary1).Add((object) "AccentBrush", ((IDictionary<object, object>) this.Resources)[(object) key]);
        ((IDictionary<object, object>) themeDictionary1).Add((object) "MenuBackground", ((IDictionary<object, object>) this.Resources)[(object) key]);
      }
      ResourceDictionary themeDictionary2 = this.GetThemeDictionary("Accent");
      if (themeDictionary2 != null && !((IDictionary<object, object>) themeDictionary2).ContainsKey((object) "AccentBrush") && !((IDictionary<object, object>) themeDictionary2).ContainsKey((object) "MenuForegroundBrush"))
      {
        ((IDictionary<object, object>) themeDictionary2).Add((object) "AccentBrush", ((IDictionary<object, object>) this.Resources)[(object) key]);
        ((IDictionary<object, object>) themeDictionary2).Add((object) "MenuForegroundBrush", ((IDictionary<object, object>) this.Resources)[(object) key]);
      }
    ...
    private Dictionary<string, SolidColorBrush> GetCustomThemeDictionary(string name) => this.themeCollection.ContainsKey(name) ? this.themeCollection[name] : (Dictionary<string, SolidColorBrush>) null;

    private Dictionary<string, SolidColorBrush> GetCustomThemeDictionary(
      ColorSchemes scheme,
      ApplicationTheme theme)
    {
      string key = (scheme == ColorSchemes.Default ? (object) "" : (object) scheme.ToString()).ToString() + (object) theme;
      return this.themeCollection.ContainsKey(key) ? this.themeCollection[key] : (Dictionary<string, SolidColorBrush>) null;
    }
      ...
      foreach (KeyValuePair<object, object> keyValuePair in (IEnumerable<KeyValuePair<object, object>>) dict)
      {
        if (keyValuePair.Value is SolidColorBrush solidColorBrush1)
        {
          if (dictionary1.ContainsKey(keyValuePair.Key as string))
          {
            ...
            ((Brush) solidColorBrush).put_Opacity(((Brush) solidColorBrush1).Opacity);
    ...
    private async void App_UnhandledException(object sender, UnhandledExceptionEventArgs e)
    {
        ...
        if (Settings.UserMode != UserMode.Owner)
        {
          using (List<Exception>.Enumerator enumerator = this.exceptions.GetEnumerator())
          {
            while (enumerator.MoveNext())
            {
              ...
              if (exception.GetType() == current.GetType() && exception.StackTrace == current.StackTrace)
                return;
            }
          }
        }
      ...
      // ISSUE: reference to a compiler-generated field
      cDisplayClass910.exceptionMessage = "Oops, looks like we've run into an internal error the developer hasn't looked out for.\n\nWould you like to report it?\n\nPlease include any information about how you came across this error in the report.";
      if (Settings.UserMode >= UserMode.Owner)
      {
        // ISSUE: reference to a compiler-generated field
        // ISSUE: reference to a compiler-generated field
    ...
    public static async Task CheckMessages(double minutesSinzeLastCheck)
    {
      ...
      try
      {
        // ISSUE: object of a compiler-generated type is created
        // ISSUE: variable of a compiler-generated type
        App.\u003C\u003Ec__DisplayClass102_0 displayClass1020 = new App.\u003C\u003Ec__DisplayClass102_0();
    ...
    private static async Task showMessageInternal(Message message)
    {
      ...
      ((FrameworkElement) messageView).put_DataContext((object) message);
      ((Control) messageView).put_VerticalContentAlignment((VerticalAlignment) 0);
      MessageView Element1 = messageView;
      (Element1.Content as FrameworkElement).put_MinHeight((double) byte.MaxValue);
      Rect bounds1 = Window.Current.Bounds;
      Rect bounds2 = ((FrameworkElement) App.Instance.RootFrame).GetBounds(Window.Current.Content);
      ((FrameworkElement) Element1).put_Width(Math.Min(bounds1.Width, 600.0));
      if (((FrameworkElement) Element1).Width > bounds1.Width - 200.0)
        ((FrameworkElement) Element1).put_Width(bounds1.Width);
      ((FrameworkElement) Element1).put_Height(Math.Min(bounds2.Bottom, 700.0));
      Point position = new Point();
      position.X = ((FrameworkElement) Element1).Width < bounds1.Width ? bounds1.Width - ((FrameworkElement) Element1).Width - 76.0 : 0.0;
      Popup popup1 = new Popup();
      popup1.put_Child((UIElement) Element1);
      ((FrameworkElement) popup1).put_RequestedTheme(App.Theme);
      Popup popup2 = popup1;
      PlaneProjection Element2 = new PlaneProjection();
      Element2.put_RotationX(-45.0);
      Element1.Content.put_Projection((Projection) Element2);
      Storyboard closeAnimation = Ani.Animation(Ani.DoubleAni((DependencyObject) Element1, "Opacity", 0.0, 0.1, (EasingFunctionBase) null, 0.0));
      Task<bool> task = DefaultPage.Current.ShowPopup(popup2, position, new Point(0.0, 0.0), lightDismissed: false, closeAnimation: closeAnimation);
      Ani.Begin((DependencyObject) Element2, "RotationX", 0.0, 0.35, (EasingFunctionBase) Ani.Ease((EasingMode) 0, 6.0));
    ...
    public static async void SendEmail(string emailAddress, string subject, string content)
    {
      ...
      int num = await Launcher.LaunchUriAsync(new Uri("mailto:" + emailAddress + "?subject=" + subject + "&body=" + content), new LauncherOptions()) ? 1 : 0;
    }
    ...
    private void HardwareButtons_BackPressed(object sender, BackPressedEventArgs e) => e.put_Handled(this.GoBack());
    ...
    private async Task initialSetup()
    {
      ...
      if (this.rootFrame == null)
      {
        ...
        Window.Current.put_Content((UIElement) defaultPage);
        Window.Current.Activate();
        Helper.Write((object) "InitialSetup", (object) "Created DefaultPage");
        this.rootFrame = defaultPage.Frame;
        this.rootFrame.put_CacheSize(4);
        CustomFrame rootFrame = this.rootFrame;
        WindowsRuntimeMarshal.AddEventHandler<NavigatedEventHandler>(new Func<NavigatedEventHandler, EventRegistrationToken>(((Frame) rootFrame).add_Navigated), new Action<EventRegistrationToken>(((Frame) rootFrame).remove_Navigated), new NavigatedEventHandler(this.RootFrame_FirstNavigated));
        Helper.Write((object) "InitialSetup", (object) "Completed window setup");
        Window current1 = Window.Current;
        WindowsRuntimeMarshal.AddEventHandler<WindowActivatedEventHandler>(new Func<WindowActivatedEventHandler, EventRegistrationToken>(current1.add_Activated), new Action<EventRegistrationToken>(current1.remove_Activated), new WindowActivatedEventHandler(this.Current_Activated));
        Window current2 = Window.Current;
        WindowsRuntimeMarshal.AddEventHandler<WindowClosedEventHandler>(new Func<WindowClosedEventHandler, EventRegistrationToken>(current2.add_Closed), new Action<EventRegistrationToken>(current2.remove_Closed), new WindowClosedEventHandler(this.Current_Closed));
      }
      bool loadOrigPage = true;
      if (App.launchTile == null && this.launchArgs != null && !this.initialized)
      {
        if (this.launchArgs != null && this.launchArgs.PreviousExecutionState == 3 && ((ContentControl) this.rootFrame).Content == null && DateTimeOffset.Now - Settings.SuspendedAt < TimeSpan.FromHours(3.0))
        {
          try
          {
            App app = this;
      ...
      if (this.activationArgs != null)
      {
        ...
        else if (this.activationArgs.Kind == 1002)
        {
          FileOpenPickerContinuationEventArgs activationArgs = this.activationArgs as FileOpenPickerContinuationEventArgs;
          loadOrigPage = false;
          if (this.rootFrame.CurrentSourcePageType == typeof (UploaderPage))
            (((ContentControl) this.rootFrame).Content as UploaderPage).SelectFile((IStorageFile) Enumerable.FirstOrDefault<StorageFile>((IEnumerable<StorageFile>) activationArgs.Files));
          else
        ...
        else if (this.activationArgs.Kind == 2)
        {
      ...
      try
      {
        if (!await new ExceptionClient().AddException(exception, App.FullDeviceName, this.globalObjects.Version))
          return;
        MessageDialog messageDialog = new MessageDialog("Looks like we ran into an issue the last time you used myTube. The details of the error have been sent to the developer.", "Uh-oh");
      }
      catch
      {
      }
    ...
    private async void YouTube_ErrorReported(YouTubeError e)
    {
      // ISSUE: object of a compiler-generated type is created
      // ISSUE: variable of a compiler-generated type
      App.\u003C\u003Ec__DisplayClass115_0 displayClass1150 = new App.\u003C\u003Ec__DisplayClass115_0();
      // ISSUE: reference to a compiler-generated field
      displayClass1150.\u003C\u003E4__this = this;
      // ISSUE: reference to a compiler-generated field
      displayClass1150.e = e;
      if (Settings.UserMode < UserMode.Owner || Window.Current == null || Window.Current.Content == null)
        return;
      // ISSUE: method pointer
      await ((DependencyObject) Window.Current.Content).Dispatcher.RunAsync((CoreDispatcherPriority) -1, new DispatchedHandler((object) displayClass1150, __methodptr(\u003CYouTube_ErrorReported\u003Eb__0)));
    }
    ...
    private void Test_Logged(object sender, TestLoggedEventArgs e) => Helper.Write((object) "Text", (object) e.Text);
    ...
    private async void Current_Activated(object sender, WindowActivatedEventArgs e)
    {
      ...
      if (!this.alreadyActivated)
      {
        ...
        if (Settings.UserMode >= UserMode.Owner)
        {
          ...
          textBlock1.put_Foreground((Brush) new SolidColorBrush(Colors.White));
          textBlock1.put_Text("start time: " + (object) App.startTime.TotalSeconds + "s");
          textBlock1.put_FontSize(17.0);
          TextBlock textBlock2 = textBlock1;
          Border border1 = new Border();
          border1.put_Background((Brush) new SolidColorBrush(Colors.Black));
          border1.put_Child((UIElement) textBlock2);
    ...
    private async Task InitialChecks() => ThreadPool.RunAsync(new WorkItemHandler((object) new App.\u003C\u003Ec__DisplayClass121_0()
    {
...
private class DisplayClass91_0
      ...
      UnobservedTaskExceptionEventArgs e)
    {
      ...
      foreach (Exception innerException in e.Exception.InnerExceptions)
      {
        // ISSUE: object of a compiler-generated type is created
        // ISSUE: variable of a compiler-generated type
        App.\u003C\u003Ec__DisplayClass130_0 displayClass1300 = new App.\u003C\u003Ec__DisplayClass130_0();
        // ISSUE: reference to a compiler-generated field
        displayClass1300.\u003C\u003E4__this = this;
        try
        {
          if (Settings.UserMode != UserMode.Owner)
          {
            using (List<Exception>.Enumerator enumerator = this.exceptions.GetEnumerator())
            {
              ...
              {
                Exception current = enumerator.Current;
                if (innerException.GetType() == current.GetType() && innerException.StackTrace == current.StackTrace)
                  return;
              }
            }
          }
        ...
        // ISSUE: method pointer
        ((DependencyObject) this.RootFrame).Dispatcher.RunAsync((CoreDispatcherPriority) 0, new DispatchedHandler((object) displayClass1300, __methodptr(\u003CTaskScheduler_UnobservedTaskException\u003Eb__0)));
      }
    }
      ...
      IBackgroundCondition condition)
    {
      ...
      backgroundTaskBuilder.put_TaskEntryPoint(entryPoint);
    ...
    {
      if (Settings.ProductKey != null || Settings.ProductKeyRequestId == null || Settings.RykenUserID == null)
        return;
      ...
      try
      {
        ...
        MessageDialog messageDialog = new MessageDialog("Your product key request has been approve, and this copy of the app has been activated.", "Product key request approved");
      }
      catch
      {
      }
    ...
    public static async Task CheckRykenUser()
    {
      // ISSUE: object of a compiler-generated type is created
      // ISSUE: variable of a compiler-generated type
      App.\u003C\u003Ec__DisplayClass135_0 displayClass1350 = new App.\u003C\u003Ec__DisplayClass135_0();
      // ISSUE: reference to a compiler-generated field
      // ISSUE: reference to a compiler-generated field
      // ISSUE: reference to a compiler-generated field
      // ISSUE: method pointer
      await ((DependencyObject) App.Instance.RootFrame).Dispatcher.RunAsync((CoreDispatcherPriority) 0, App.\u003C\u003Ec.\u003C\u003E9__135_0 ?? (App.\u003C\u003Ec.\u003C\u003E9__135_0 = new DispatchedHandler((object) App.\u003C\u003Ec.\u003C\u003E9, __methodptr(\u003CCheckRykenUser\u003Eb__135_0))));
      // ISSUE: reference to a compiler-generated field
      ...
      if (Settings.RykenUserID != null)
      {
        try
        {
          // ISSUE: object of a compiler-generated type is created
          // ISSUE: variable of a compiler-generated type
          App.\u003C\u003Ec__DisplayClass135_1 displayClass1351 = new App.\u003C\u003Ec__DisplayClass135_1();
          // ISSUE: reference to a compiler-generated field
          displayClass1351.CS\u0024\u003C\u003E8__locals1 = displayClass1350;
          // ISSUE: reference to a compiler-generated field
          RykenUser user1 = displayClass1351.user;
          // ISSUE: reference to a compiler-generated field
          // ISSUE: reference to a compiler-generated field
          RykenUser rykenUser1 = await displayClass1351.CS\u0024\u003C\u003E8__locals1.userClient.Login(Settings.RykenUserID);
          // ISSUE: reference to a compiler-generated field
          ...
          if (displayClass1351.user != null)
          {
            ...
            {
              // ISSUE: method pointer
              await ((DependencyObject) App.Instance.RootFrame).Dispatcher.RunAsync((CoreDispatcherPriority) 0, new DispatchedHandler((object) displayClass1351, __methodptr(\u003CCheckRykenUser\u003Eb__1)));
            }
          }
          // ISSUE: reference to a compiler-generated field
          // ISSUE: reference to a compiler-generated field
          if (displayClass1351.user != null && SharedSettings.CurrentAccount != null && SharedSettings.CurrentAccount.UserName != displayClass1351.user.Name)
          {
            try
            {
              // ISSUE: reference to a compiler-generated field
              // ISSUE: reference to a compiler-generated field
              // ISSUE: reference to a compiler-generated field
              RykenUser rykenUser2 = await displayClass1351.CS\u0024\u003C\u003E8__locals1.userClient.ChangeName(displayClass1351.user.Id, SharedSettings.CurrentAccount.UserName);
            }
            catch
            {
            }
          ...
          displayClass1351 = (App.\u003C\u003Ec__DisplayClass135_1) null;
        }
        catch
        {
          flag = true;
    ...
    public void SetThemeBrushOpacity(string key, ApplicationTheme theme, double opacity)
    {
      ...
      if (!((IDictionary<object, object>) themeDictionary).ContainsKey((object) key))
        return;
      ((Brush) (((IDictionary<object, object>) themeDictionary)[(object) key] as SolidColorBrush)).put_Opacity(opacity);
    }
    ...
    public void SetThemeBrushColor(string key, ApplicationTheme theme, Color color)
    {
      ...
      if (!((IDictionary<object, object>) themeDictionary).ContainsKey((object) key))
        return;
      (((IDictionary<object, object>) themeDictionary)[(object) key] as SolidColorBrush).put_Color(color);
    }
    ...
    public ResourceDictionary GetThemeDictionary()
    {
      ...
      return theme == 1 ? this.GetThemeDictionary((ApplicationTheme) 0) : this.GetThemeDictionary(this.RequestedTheme);
    }

    public ResourceDictionary GetThemeDictionary(ApplicationTheme theme)
    {
      string key = theme.ToString();
      return this.Resources.ThemeDictionaries.ContainsKey((object) key) ? (ResourceDictionary) this.Resources.ThemeDictionaries[(object) key] : (ResourceDictionary) null;
    }

    public ResourceDictionary GetThemeDictionary(string name)
    {
      foreach (ResourceDictionary mergedDictionary in (IEnumerable<ResourceDictionary>) this.Resources.MergedDictionaries)
      {
      ...
      return this.Resources.ThemeDictionaries.ContainsKey((object) name) ? (ResourceDictionary) this.Resources.ThemeDictionaries[(object) name] : (ResourceDictionary) null;
    }

    protected virtual async void OnShareTargetActivated(ShareTargetActivatedEventArgs args)
    {
      ...
      if (args.Kind == 2)
      {
        if (args.ShareOperation.Data.Contains(StandardDataFormats.WebLink))
        {
          ...
          Window current1 = Window.Current;
          WindowsRuntimeMarshal.AddEventHandler<WindowActivatedEventHandler>(new Func<WindowActivatedEventHandler, EventRegistrationToken>(current1.add_Activated), new Action<EventRegistrationToken>(current1.remove_Activated), new WindowActivatedEventHandler(this.WindowShareTargetActivated));
          this.windowActivatedTask = new TaskCompletionSource<bool>();
          TaskCompletionSource<bool> visibiltyTask = new TaskCompletionSource<bool>();
          Window current2 = Window.Current;
          WindowsRuntimeMarshal.AddEventHandler<WindowVisibilityChangedEventHandler>(new Func<WindowVisibilityChangedEventHandler, EventRegistrationToken>(current2.add_VisibilityChanged), new Action<EventRegistrationToken>(current2.remove_VisibilityChanged), (WindowVisibilityChangedEventHandler) ((s, e) =>
          {
            if (!e.Visible)
              return;
    ...
    {
      WindowsRuntimeMarshal.RemoveEventHandler<WindowActivatedEventHandler>(new Action<EventRegistrationToken>(Window.Current.remove_Activated), new WindowActivatedEventHandler(this.WindowShareTargetActivated));
      this.windowActivatedTask.TrySetResult(true);
    }

    public void StartCallback(ApplicationInitializationCallbackParams par) => Helper.Write((object) "Start callback");
    ...
    public void OpenSettings()
    {
      ...
      DefaultPage.SetPopupArrangeMethod((DependencyObject) popup2, (Func<Point>) (() =>
      {
        ...
        ((FrameworkElement) settings).put_Width(Math.Min(500.0, bounds2.Width));
        ((FrameworkElement) settings).put_Height(Math.Min(700.0, bounds2.Bottom - bounds1.Top));
        return new Point()
        {
    ...
    private async void OnSuspending(object sender, SuspendingEventArgs e)
    {
      ...
      if (DefaultPage.Current != null)
      {
        ...
        if (App.DeviceFamily == DeviceFamily.Mobile && Settings.ResumeAsAudio && vp.MediaElement.CurrentState == 3)
        {
    ...
    private Task<bool> waitForBackgroundMedia(TimeSpan timeout)
    {
      // ISSUE: object of a compiler-generated type is created
      // ISSUE: variable of a compiler-generated type
      App.\u003C\u003Ec__DisplayClass152_0 displayClass1520 = new App.\u003C\u003Ec__DisplayClass152_0();
      // ISSUE: reference to a compiler-generated field
      ...
      dispatcherTimer.put_Interval(timeout);
      // ISSUE: reference to a compiler-generated field
      ...
      // ISSUE: reference to a compiler-generated field
      // ISSUE: method pointer
      displayClass1520.opened = new TypedEventHandler<MediaPlayer, object>((object) displayClass1520, __methodptr(\u003CwaitForBackgroundMedia\u003Eb__0));
      // ISSUE: reference to a compiler-generated field
      ...
      displayClass1520.tick = new EventHandler<object>(displayClass1520.\u003CwaitForBackgroundMedia\u003Eb__2);
      // ISSUE: reference to a compiler-generated field
