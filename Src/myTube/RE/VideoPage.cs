...
namespace myTube
{
  public sealed class VideoPage : Page, IDownloadPanelCallbackReceiver, IComponentConnector
  {
    ...
    public VideoPage()
    {
      ...
      ((FrameworkElement) this).put_Tag((object) nameof (VideoPage));
      WindowsRuntimeMarshal.AddEventHandler<SizeChangedEventHandler>(new Func<SizeChangedEventHandler, EventRegistrationToken>(((FrameworkElement) this).add_SizeChanged), new Action<EventRegistrationToken>(((FrameworkElement) this).remove_SizeChanged), new SizeChangedEventHandler(this.OverCanvasTestPage_SizeChanged));
      this.put_NavigationCacheMode((NavigationCacheMode) 2);
      // ISSUE: method pointer
      WindowsRuntimeMarshal.AddEventHandler<TypedEventHandler<FrameworkElement, DataContextChangedEventArgs>>(new Func<TypedEventHandler<FrameworkElement, DataContextChangedEventArgs>, EventRegistrationToken>(((FrameworkElement) this).add_DataContextChanged), new Action<EventRegistrationToken>(((FrameworkElement) this).remove_DataContextChanged), new TypedEventHandler<FrameworkElement, DataContextChangedEventArgs>((object) this, __methodptr(OverCanvasTestPage_DataContextChanged)));
      ...
      WindowsRuntimeMarshal.AddEventHandler<RoutedEventHandler>(new Func<RoutedEventHandler, EventRegistrationToken>(((FrameworkElement) this).add_Loaded), new Action<EventRegistrationToken>(((FrameworkElement) this).remove_Loaded), new RoutedEventHandler(this.VideoPage_Loaded));
      WindowsRuntimeMarshal.AddEventHandler<RoutedEventHandler>(new Func<RoutedEventHandler, EventRegistrationToken>(((FrameworkElement) this).add_Unloaded), new Action<EventRegistrationToken>(((FrameworkElement) this).remove_Unloaded), new RoutedEventHandler(this.VideoPage_Unloaded));
    }
    ...
    private void TransferManager_OnAction(object sender, TransferManagerActionEventArgs e)
    {
      ...
      VideoPage.\u003C\u003Ec__DisplayClass9_0 cDisplayClass90 = new VideoPage.\u003C\u003Ec__DisplayClass9_0();
      ...
      if (cDisplayClass90.e.Action != TransferManagerAction.Removed)
        return;
      // ISSUE: method pointer
      ((DependencyObject) this).Dispatcher.RunAsync((CoreDispatcherPriority) 0, new DispatchedHandler((object) cDisplayClass90, __methodptr(\u003CTransferManager_OnAction\u003Eb__0)));
    }
    ...
    private void dataTM_DataRequested(DataTransferManager sender, DataRequestedEventArgs args)
    {
      ...
      data.Properties.put_Title(dataContext.Title + " #myTube");
      data.Properties.put_Description(dataContext.Description + "\n#myTube");
