...
namespace myTube
{
  public sealed class VideoList : UserControl, IComponentConnector
  {
    public DependencyProperty ContextMenuProperty = DependencyProperty.Register(nameof (ContextMenu), typeof (IconButtonEventCollection), typeof (VideoList), new PropertyMetadata((object) null));
    public static DependencyProperty ListPaddingProperty = DependencyProperty.Register(nameof (ListPadding), typeof (Thickness), typeof (VideoList), new PropertyMetadata((object) new Thickness(0.0, 0.0, -19.0, 0.0)));
    public static DependencyProperty ThumbPaddingProperty = DependencyProperty.Register(nameof (ThumbPadding), typeof (Thickness), typeof (VideoList), new PropertyMetadata((object) new Thickness(0.0, 0.0, 19.0, 19.0)));
    public static DependencyProperty EntriesProperty = DependencyProperty.Register(nameof (Entries), typeof (ObservableCollection<YouTubeEntry>), typeof (VideoList), new PropertyMetadata((object) null, new PropertyChangedCallback(VideoList.OnEntriesChanged)));
    public static DependencyProperty ClientProperty = DependencyProperty.Register(nameof (Client), typeof (VideoListClient), typeof (VideoList), new PropertyMetadata((object) null, new PropertyChangedCallback(VideoList.OnClientChanged)));
    public static DependencyProperty LoadOnScrollProperty = DependencyProperty.Register(nameof (LoadOnScroll), typeof (bool), typeof (VideoList), new PropertyMetadata((object) true));
    public static DependencyProperty AutomaticallyLoadDataProperty = DependencyProperty.Register(nameof (AutomaticallyLoadData), typeof (bool), typeof (VideoList), new PropertyMetadata((object) true));
    public static DependencyProperty AllowPlaylistModeProperty = DependencyProperty.Register(nameof (AllowPlaylistMode), typeof (bool), typeof (VideoList), new PropertyMetadata((object) true));
    public static DependencyProperty LoadVideosFuncProperty = DependencyProperty.Register(nameof (LoadVideosFunc), typeof (Func<int, Task<YouTubeEntry[]>>), typeof (VideoList), new PropertyMetadata((object) null, new PropertyChangedCallback(VideoList.OnLoadVideosFuncChanged)));
    public static DependencyProperty SortVideosFuncProperty = DependencyProperty.Register(nameof (SortVideosFunc), typeof (Func<YouTubeEntry, YouTubeEntry, bool>), typeof (VideoList), new PropertyMetadata((object) null, new PropertyChangedCallback(VideoList.OnSortVideosFuncChanged)));
    public static DependencyProperty DependsOnSignInProperty = DependencyProperty.Register(nameof (DependsOnSignIn), typeof (bool), typeof (VideoList), new PropertyMetadata((object) false, new PropertyChangedCallback(VideoList.DependsOnSignInChanged)));
    public static DependencyProperty IsSignedInProperty = DependencyProperty.Register(nameof (IsSignedIn), typeof (bool), typeof (VideoList), new PropertyMetadata((object) false, new PropertyChangedCallback(VideoList.IsSignedInChanged)));
    private int page;
    private bool loaded;
    ...
    [GeneratedCode("Microsoft.Windows.UI.Xaml.Build.Tasks", " 4.0.0.0")]
    private IconButtonEventCollection contextMenuCollection;
    [GeneratedCode("Microsoft.Windows.UI.Xaml.Build.Tasks", " 4.0.0.0")]
    ...
    [GeneratedCode("Microsoft.Windows.UI.Xaml.Build.Tasks", " 4.0.0.0")]
    private ContentControl cancelSelectedButton;
    [GeneratedCode("Microsoft.Windows.UI.Xaml.Build.Tasks", " 4.0.0.0")]
    private ContentControl acceptSelectedButton;
    [GeneratedCode("Microsoft.Windows.UI.Xaml.Build.Tasks", " 4.0.0.0")]
    private SymbolIcon multiSelectSymbol;
    [GeneratedCode("Microsoft.Windows.UI.Xaml.Build.Tasks", " 4.0.0.0")]
    ...
    private static void OnEntriesChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
    {
      ...
      if (oldValue != null)
        oldValue.CollectionChanged -= new NotifyCollectionChangedEventHandler(videoList.newEntries_CollectionChanged);
      if (newValue == null)
        return;
      newValue.CollectionChanged += new NotifyCollectionChangedEventHandler(videoList.newEntries_CollectionChanged);
    }
    ...
    public ListStrings ListStrings => this.listStrings;
    ...
    public IconButtonEventCollection ContextMenu => (IconButtonEventCollection) ((DependencyObject) this).GetValue(this.ContextMenuProperty);
    ...
    {
      this.isSorting = !this.isSorting ? true : throw new InvalidOperationException("Please complete the current sorting operation before beginning a new one");
      ...
      WindowsRuntimeMarshal.AddEventHandler<EventHandler<object>>(new Func<EventHandler<object>, EventRegistrationToken>(((FrameworkElement) panel).add_LayoutUpdated), new Action<EventRegistrationToken>(((FrameworkElement) panel).remove_LayoutUpdated), new EventHandler<object>(this.panel_LayoutUpdated));
      foreach (UIElement child1 in (IEnumerable<UIElement>) itemsPanelRoot.Children)
      {
        foreach (FrameworkElement child2 in Helper.FindChildren<FrameworkElement>((DependencyObject) (child1 as FrameworkElement), 10))
        {
          if (child2 is ISortableThumbnail<YouTubeEntry>)
          {
            ...
            ((UIElement) child2).put_RenderTransformOrigin(new Point(0.5, 0.5));
            ((UIElement) child2).put_RenderTransform((Transform) compositeTransform);
    ...
    public Dictionary<YouTubeEntry, int> EndSort()
    {
      ...
      if (this.ItemList.ItemsPanelRoot != null)
      {
        ...
        WindowsRuntimeMarshal.RemoveEventHandler<EventHandler<object>>(new Action<EventRegistrationToken>((object) itemsPanelRoot, __vmethodptr(itemsPanelRoot, remove_LayoutUpdated)), new EventHandler<object>(this.panel_LayoutUpdated));
        foreach (UIElement child1 in (IEnumerable<UIElement>) itemsPanelRoot.Children)
        {
          foreach (FrameworkElement child2 in Helper.FindChildren<FrameworkElement>((DependencyObject) (child1 as FrameworkElement), 10))
          {
    ...
    private void setSortTrans(UIElement el, bool isSort)
    {
      ...
      if (!(el.RenderTransform is CompositeTransform Element))
      {
        ...
        el.put_RenderTransform((Transform) Element);
      }
      el.put_RenderTransformOrigin(new Point(0.5, 0.5));
      if (isSort)
        Ani.Begin((Timeline) Ani.DoubleAni((DependencyObject) Element, "ScaleX", 1.0, 0.2, (EasingFunctionBase) Ani.Ease((EasingMode) 0, 3.0)), (Timeline) Ani.DoubleAni((DependencyObject) Element, "ScaleY", 1.0, 0.2, (EasingFunctionBase) Ani.Ease((EasingMode) 0, 3.0)), (Timeline) Ani.DoubleAni((DependencyObject) el, "Opacity", 1.0, 0.1));
      else
        Ani.Begin((Timeline) Ani.DoubleAni((DependencyObject) Element, "ScaleX", 0.8, 0.2, (EasingFunctionBase) Ani.Ease((EasingMode) 0, 3.0)), (Timeline) Ani.DoubleAni((DependencyObject) Element, "ScaleY", 0.8, 0.2, (EasingFunctionBase) Ani.Ease((EasingMode) 0, 3.0)), (Timeline) Ani.DoubleAni((DependencyObject) el, "Opacity", 0.6, 0.1));
    }
    ...
    private void AdjustPanelSize(Size size)
    {
      ...
      if (size.Width > 1760.0)
      {
        ...
        itemsPanelRoot.put_ItemWidth((size.Width + num) / 4.0);
      }
      else if (size.Width > 1160.0)
      {
        this.ThumbPadding = new Thickness(0.0, 0.0, 19.0, 19.0);
        itemsPanelRoot.put_ItemWidth((size.Width + num) / 3.0);
      }
      else if (size.Width > 665.0 || size.Width > size.Height && size.Width > 400.0 && size.Height < 480.0)
      {
        this.ThumbPadding = new Thickness(0.0, 0.0, 19.0, 19.0);
        itemsPanelRoot.put_ItemWidth((size.Width + num) / 2.0);
      }
      else
      {
        this.ThumbPadding = new Thickness(0.0, 0.0, 0.0, 19.0);
        itemsPanelRoot.put_ItemWidth(size.Width);
      }
    }
    ...
    public Task<bool> Clear(bool animate)
    {
      ...
      if (animate)
      {
          ...
          try
          {
            foreach (UIElement child in (IEnumerable<UIElement>) this.ItemList.ItemsPanelRoot.Children)
            {
              if (child is FrameworkElement frameworkElement)
              {
                ...
                if (bounds.Top > 0.0 && bounds.Top < this.scroll.ViewportHeight || bounds.Bottom > 0.0 && bounds.Bottom < this.scroll.ViewportHeight)
                {
                  TranslateTransform Element = new TranslateTransform();
                  ((UIElement) frameworkElement).put_RenderTransform((Transform) Element);
                  sb.Add((Timeline) Ani.DoubleAni((DependencyObject) frameworkElement, "Opacity", 0.0, 0.15, (EasingFunctionBase) Ani.Ease((EasingMode) 2, 1.0), startTime), (Timeline) Ani.DoubleAni((DependencyObject) Element, "Y", -50.0, 0.15, (EasingFunctionBase) Ani.Ease((EasingMode) 1, 5.0), startTime));
                  startTime += num;
                }
              }
            }
        ...
        WindowsRuntimeMarshal.AddEventHandler<EventHandler<object>>(new Func<EventHandler<object>, EventRegistrationToken>(((Timeline) storyboard).add_Completed), new Action<EventRegistrationToken>(((Timeline) storyboard).remove_Completed), (EventHandler<object>) ((_param1, _param2) =>
        {
          ...
          foreach (UIElement child in (IEnumerable<UIElement>) this.ItemList.ItemsPanelRoot.Children)
          {
            child.put_Opacity(1.0);
            child.put_RenderTransform((Transform) null);
          }
    ...
    public static void TappedThumb(FrameworkElement thumb)
    {
      ...
      if (parentFromTree != null)
      {
        ...
        if (parentFromTree.isSorting && thumb is ISortableThumbnail<YouTubeEntry> thumb1)
          ...
          (Application.Current as App).RootFrame.Navigate(typeof (VideoPage), (object) new VideoPage.ClientConstructorAndEntry()
          {
