...
namespace myTube
{
  public class OverCanvas : Panel, IScrollSnapPointsInfo
  {
    ...
    public static readonly DependencyProperty OverCanvasWidthProperty = DependencyProperty.RegisterAttached("OverCanvasWidth", typeof (double), typeof (UIElement), new PropertyMetadata((object) double.NaN, new PropertyChangedCallback(OverCanvas.OnOverCanvasWidthChanged)));
    public static readonly DependencyProperty ScrolledToOrAdjacentProperty = DependencyProperty.RegisterAttached("ScrolledToOrAdjacent", typeof (Action), typeof (UIElement), new PropertyMetadata((object) null));
    private static readonly DependencyProperty OverCanvasDesiredWidthProperty = DependencyProperty.RegisterAttached("OverCanvasDesiredWidth", typeof (double), typeof (UIElement), new PropertyMetadata((object) 390.0));
    public static readonly DependencyProperty OverCanvasMaxWidthProperty = DependencyProperty.RegisterAttached("OverCanvasMaxWidth", typeof (double), typeof (UIElement), new PropertyMetadata((object) double.MaxValue));
    public static readonly DependencyProperty HorizontalPaddingProperty = DependencyProperty.Register(nameof (HorizontalPadding), typeof (Thickness), typeof (OverCanvas), new PropertyMetadata((object) new Thickness(19.0, 0.0, 19.0, 0.0)));
    public static readonly DependencyProperty TitleProperty = DependencyProperty.Register(nameof (Title), typeof (string), typeof (OverCanvas), new PropertyMetadata((object) null));
    public static readonly DependencyProperty ScrollViewerProperty = DependencyProperty.Register("ScrollViewer", typeof (ScrollViewer), typeof (OverCanvas), new PropertyMetadata((object) null, new PropertyChangedCallback(OverCanvas.OnScrollViewerChanged)));
    public static readonly DependencyProperty OverCanvasTitleProperty = DependencyProperty.RegisterAttached("OverCanvasTitle", typeof (string), typeof (UIElement), new PropertyMetadata((object) "page"));
    public static readonly DependencyProperty OverCanvasWidthTypeProperty = DependencyProperty.RegisterAttached("OverCanvasWidthType", typeof (OverCanvasWidthType), typeof (UIElement), new PropertyMetadata((object) OverCanvasWidthType.Pixel));
    public static readonly DependencyProperty PageTitlesProperty = DependencyProperty.Register(nameof (PageTitles), typeof (string[]), typeof (OverCanvas), new PropertyMetadata((object) new string[0]));
    public static readonly DependencyProperty SelectedPageProperty = DependencyProperty.Register(nameof (SelectedPage), typeof (int), typeof (OverCanvas), new PropertyMetadata((object) -2, new PropertyChangedCallback(OverCanvas.OnSelectedPagePropertyChanged)));
    public static readonly DependencyProperty SelectedIndexProperty = DependencyProperty.Register(nameof (SelectedIndex), typeof (int), typeof (OverCanvas), new PropertyMetadata((object) 0, new PropertyChangedCallback(OverCanvas.OnSelectedIndexPropertyChanged)));
    public static readonly DependencyProperty ShownProperty = DependencyProperty.Register(nameof (Shown), typeof (bool), typeof (OverCanvas), new PropertyMetadata((object) true, new PropertyChangedCallback(OverCanvas.OnShownPropertyChanged)));
    public static readonly DependencyProperty VerticalOffsetHelperProperty = DependencyProperty.Register("VerticalOffsetHelper", typeof (double), typeof (OverCanvas), new PropertyMetadata((object) 0, new PropertyChangedCallback(OverCanvas.OnVerticalOffsetHelperPropertyChanged)));
    public static readonly DependencyProperty HorizontalOffsetHelperProperty = DependencyProperty.Register("HorizontalOffsetHelper", typeof (double), typeof (OverCanvas), new PropertyMetadata((object) 0, new PropertyChangedCallback(OverCanvas.OnHorizontalOffsetHelperPropertyChanged)));
    public static readonly DependencyProperty TitleBackgroundBrushProperty = DependencyProperty.Register(nameof (TitleBackgroundBrush), typeof (Brush), typeof (OverCanvas), new PropertyMetadata((object) null, new PropertyChangedCallback(OverCanvas.OnTitleBackgroundBrushPropertyChanged)));
    public static readonly DependencyProperty TitleForegroundBrushProperty = DependencyProperty.Register(nameof (TitleForegroundBrush), typeof (Brush), typeof (OverCanvas), new PropertyMetadata((object) null));
    public static readonly DependencyProperty OverCanvasShownProperty = DependencyProperty.RegisterAttached("OverCanvasShown", typeof (bool), typeof (UIElement), new PropertyMetadata((object) true, new PropertyChangedCallback(OverCanvas.OverCanvasShownPropertyChanged)));
    public static readonly DependencyProperty SignedInProperty = DependencyProperty.Register(nameof (SignedIn), typeof (bool), typeof (OverCanvas), new PropertyMetadata((object) null, new PropertyChangedCallback(OverCanvas.OnSignedInPropertyChanged)));
    public static readonly DependencyProperty BannerReadyProperty = DependencyProperty.Register(nameof (BannerReady), typeof (bool), typeof (OverCanvas), new PropertyMetadata((object) false));
    public static readonly DependencyProperty OverCanvasPageProperty = DependencyProperty.Register("OverCanvasPage", typeof (int), typeof (UIElement), new PropertyMetadata((object) 0, new PropertyChangedCallback(OverCanvas.OverCanvasPagePropertyChanged)));
    public static readonly DependencyProperty TitleVisibilityProperty = DependencyProperty.Register("TitleVisiblity", typeof (Visibility), typeof (OverCanvas), new PropertyMetadata((object) (Visibility) 1));
    ...
    private static void OnFlipStyleChanged(DependencyObject d, DependencyPropertyChangedEventArgs e) => (d as OverCanvas).Invalidate();
    ...
    private static void OnHorizontalOffsetHelperPropertyChanged(
      ...
      DependencyPropertyChangedEventArgs e)
    {
      (((DependencyObject) (d as OverCanvas)).GetValue(OverCanvas.ScrollViewerProperty) as ScrollViewer).ScrollToHorizontalOffset((double) e.NewValue);
    }
    ...
    private static void OnVerticalOffsetHelperPropertyChanged(
      ...
      DependencyPropertyChangedEventArgs e)
    {
      (((DependencyObject) (d as OverCanvas)).GetValue(OverCanvas.ScrollViewerProperty) as ScrollViewer).ChangeView(new double?(), new double?((double) e.NewValue), new float?(), true);
    }
      ...
      DependencyPropertyChangedEventArgs e)
    {
      ...
      if (!parent.IsSelectedOrAdjacent(newValue) || parent.IsSelectedOrAdjacent(oldValue) && !parent.callEventsWeakCheck)
        return;
    ...
    public void CallSelectedOrAdjacent()
    {
      foreach (UIElement child in (IEnumerable<UIElement>) this.Children)
      {
        ...
        if (this.IsSelectedOrAdjacent(overCanvasPage, this.SelectedPage) && (!this.IsSelectedOrAdjacent(overCanvasPage, this.prevPage) || !this.firstPageChange || this.callEventsWeakCheck))
        {
    ...
    private void newScroll_ViewChanged(object sender, ScrollViewerViewChangedEventArgs e)
    {
      ...
      // ISSUE: reference to a compiler-generated field
      if (cDisplayClass490.s.HorizontalSnapPointsType != 4 && !this.resettingSnapPoints && Math.Abs(num) < 2.5)
      {
        this.resettingSnapPoints = true;
        // ISSUE: method pointer
        ThreadPoolTimer.CreateTimer(new TimerElapsedHandler((object) cDisplayClass490, __methodptr(\u003CnewScroll_ViewChanged\u003Eb__0)), TimeSpan.FromMilliseconds(200.0));
      }
      // ISSUE: reference to a compiler-generated field
      this.SetIndexBasedOnScroll(cDisplayClass490.s.HorizontalOffset);
    }

    public static bool GetOverCanvasShown(DependencyObject obj) => (bool) obj.GetValue(OverCanvas.OverCanvasShownProperty);

    public static void SetOverCanvasShown(DependencyObject obj, bool value) => obj.SetValue(OverCanvas.OverCanvasShownProperty, (object) value);

    public static int GetOverCanvasPage(DependencyObject obj) => (int) obj.GetValue(OverCanvas.OverCanvasPageProperty);

    public static void SetOverCanvasPage(DependencyObject obj, int value) => obj.SetValue(OverCanvas.OverCanvasPageProperty, (object) value);

    public static OverCanvasWidthType GetOverCanvasWidthType(DependencyObject obj) => (OverCanvasWidthType) obj.GetValue(OverCanvas.OverCanvasWidthTypeProperty);

    public static void SetOverCanvasWidthType(DependencyObject obj, OverCanvasWidthType value) => obj.SetValue(OverCanvas.OverCanvasWidthTypeProperty, (object) value);

    public static double GetOverCanvasWidth(DependencyObject obj) => (double) obj.GetValue(OverCanvas.OverCanvasWidthProperty);

    public static void SetOverCanvasWidth(DependencyObject obj, double value) => obj.SetValue(OverCanvas.OverCanvasWidthProperty, (object) value);

    public static double GetOverCanvasMaxWidth(DependencyObject obj) => (double) obj.GetValue(OverCanvas.OverCanvasMaxWidthProperty);

    public static void SetOverCanvasMaxWidth(DependencyObject obj, double value) => obj.SetValue(OverCanvas.OverCanvasMaxWidthProperty, (object) value);

    public static string GetOverCanvasTitle(DependencyObject obj) => (string) obj.GetValue(OverCanvas.OverCanvasTitleProperty);

    public static void SetOverCanvasTitle(DependencyObject obj, string value) => obj.SetValue(OverCanvas.OverCanvasTitleProperty, (object) value);

    public static double GetHorizontalOffsetHelper(DependencyObject obj) => (double) obj.GetValue(OverCanvas.HorizontalOffsetHelperProperty);

    public static void SetHorizontalOffsetHelper(DependencyObject obj, double value) => obj.SetValue(OverCanvas.HorizontalOffsetHelperProperty, (object) value);

    public static Action GetScrolledToOrAdjacent(DependencyObject obj) => (Action) obj.GetValue(OverCanvas.ScrolledToOrAdjacentProperty);

    public static void SetScrolledToOrAdjacent(DependencyObject obj, Action value) => obj.SetValue(OverCanvas.ScrolledToOrAdjacentProperty, (object) value);
    ...
    public OverCanvas()
    {
      WindowsRuntimeMarshal.AddEventHandler<SizeChangedEventHandler>(new Func<SizeChangedEventHandler, EventRegistrationToken>(((FrameworkElement) this).add_SizeChanged), new Action<EventRegistrationToken>(((FrameworkElement) this).remove_SizeChanged), new SizeChangedEventHandler(this.OverCanvas_SizeChanged));
      // ISSUE: method pointer
      WindowsRuntimeMarshal.AddEventHandler<TypedEventHandler<FrameworkElement, DataContextChangedEventArgs>>(new Func<TypedEventHandler<FrameworkElement, DataContextChangedEventArgs>, EventRegistrationToken>(((FrameworkElement) this).add_DataContextChanged), new Action<EventRegistrationToken>(((FrameworkElement) this).remove_DataContextChanged), new TypedEventHandler<FrameworkElement, DataContextChangedEventArgs>((object) this, __methodptr(OverCanvas_DataContextChanged)));
      WindowsRuntimeMarshal.AddEventHandler<RoutedEventHandler>(new Func<RoutedEventHandler, EventRegistrationToken>(((FrameworkElement) this).add_Loaded), new Action<EventRegistrationToken>(((FrameworkElement) this).remove_Loaded), new RoutedEventHandler(this.OverCanvas_Loaded));
      WindowsRuntimeMarshal.AddEventHandler<RoutedEventHandler>(new Func<RoutedEventHandler, EventRegistrationToken>(((FrameworkElement) this).add_Unloaded), new Action<EventRegistrationToken>(((FrameworkElement) this).remove_Unloaded), new RoutedEventHandler(this.OverCanvas_Unloaded));
    }
      ...
      if (scrollViewer != null)
      {
        ...
        else if (this.FlipStyle == FlipStyle.Pivot)
        {
          ...
          if (this.snaps.Count > 2 && scroll > (double) this.snaps[this.snaps.Count - 2])
          {
            ...
            else
            {
              ...
              if (((UIElement) scrollViewer).Opacity != o)
                ((UIElement) scrollViewer).put_Opacity(o);
          ...
          else if (this.snaps.Count > 2 && scroll < (double) this.snaps[1])
          {
            ...
            ((UIElement) scrollViewer).put_Opacity(1.0);
        }
      }
      if (!flag)
        return;
    ...
    public void Move(double pixels)
    {
      ...
      if (this.scrollTransform == null)
      {
        ...
        ((UIElement) this).put_RenderTransform((Transform) this.scrollTransform);
      }
      TranslateTransform scrollTransform = this.scrollTransform;
      scrollTransform.put_X(scrollTransform.X + pixels);
    }
    ...
    public void ScrollToIndex(int index, bool cancelAnimations, bool usePropertyAnimation = false)
    {
      if (((ICollection<UIElement>) this.Children).Count > index)
        this.ScrollToPage(OverCanvas.GetOverCanvasPage((DependencyObject) ((IList<UIElement>) this.Children)[index]), cancelAnimations, usePropertyAnimation);
      else
      ...
      bool easeInOut = true)
    {
      ...
      if (!cancelAnimations)
      {
        if (this.SelectedPage == -1 && page == -1)
        {
          ...
          this.scrollTransform.put_X(scroll.HorizontalOffset - (double) this.snaps[this.snaps.Count - 1]);
        }
        else if (this.SelectedPage == this.snaps.Count - 2 && page == 0 && this.snaps.Count > 1)
        {
          page = 1;
          this.scrollTransform.put_X(scroll.HorizontalOffset - 0.0);
        }
      }
        ...
        if (!cancelAnimations)
        {
          ...
          if (this.FlipStyle == FlipStyle.Classic)
          {
            ...
            WindowsRuntimeMarshal.AddEventHandler<EventHandler<object>>(new Func<EventHandler<object>, EventRegistrationToken>(((Timeline) storyboard).add_Completed), new Action<EventRegistrationToken>(((Timeline) storyboard).remove_Completed), (EventHandler<object>) ((_param1, _param2) =>
            {
              ...
              this.scrollTransform.put_X(0.0);
              ((UIElement) this).put_RenderTransform((Transform) null);
            }));
          }
          else
          {
            ...
            page = this.snaps.Count - 2;
            this.SetIndexBasedOnScroll((double) this.snaps[page]);
            Storyboard storyboard1 = Ani.Begin((Timeline) Ani.DoubleAni((DependencyObject) this.scrollTransform, "X", (double) this.snapWidth / 2.0, timeShort, (EasingFunctionBase) Ease2), (Timeline) Ani.DoubleAni((DependencyObject) this, "Opacity", 0.0, timeShort));
            WindowsRuntimeMarshal.AddEventHandler<EventHandler<object>>(new Func<EventHandler<object>, EventRegistrationToken>(((Timeline) storyboard1).add_Completed), new Action<EventRegistrationToken>(((Timeline) storyboard1).remove_Completed), (EventHandler<object>) ((_param1_1, _param2_1) =>
            {
              this.scrollTransform.put_X(scroll.HorizontalOffset - (double) this.snaps[page] - (double) this.snapWidth / 2.0);
              Storyboard storyboard2 = Ani.Begin((Timeline) Ani.DoubleAni((DependencyObject) this.scrollTransform, "X", scroll.HorizontalOffset - (double) this.snaps[page], timeShort, (EasingFunctionBase) easeShortOut), (Timeline) Ani.DoubleAni((DependencyObject) this, "Opacity", 1.0, timeShort));
              WindowsRuntimeMarshal.AddEventHandler<EventHandler<object>>(new Func<EventHandler<object>, EventRegistrationToken>(((Timeline) storyboard2).add_Completed), new Action<EventRegistrationToken>(((Timeline) storyboard2).remove_Completed), (EventHandler<object>) ((_param1_2, _param2_2) =>
              {
                page %= this.snaps.Count;
                scroll.ChangeView(new double?((double) this.snaps[page]), new double?(), new float?(), true);
                this.scrollTransform.put_X(0.0);
      ...
      else if (page > 0 && this.snaps.Count - 1 > page)
      {
        if (!cancelAnimations | usePropertyAnimation)
        {
          ...
          page %= this.snaps.Count;
          this.SetIndexBasedOnScroll((double) this.snaps[page]);
          Storyboard storyboard = Ani.Begin((DependencyObject) this.scrollTransform, "X", scroll.HorizontalOffset - (double) this.snaps[page], Duration, (EasingFunctionBase) Ease1);
          WindowsRuntimeMarshal.AddEventHandler<EventHandler<object>>(new Func<EventHandler<object>, EventRegistrationToken>(((Timeline) storyboard).add_Completed), new Action<EventRegistrationToken>(((Timeline) storyboard).remove_Completed), (EventHandler<object>) ((_param1, _param2) =>
          {
            page %= this.snaps.Count;
            scroll.ChangeView(new double?((double) this.snaps[page]), new double?(), new float?(), true);
      ...
      else
      {
        ...
        if (!cancelAnimations)
        {
          ...
          if (this.FlipStyle == FlipStyle.Classic)
          {
            Storyboard storyboard = Ani.Begin((DependencyObject) this.scrollTransform, "X", scroll.HorizontalOffset - (double) this.snaps[this.snaps.Count - 1] - 2.0, Duration, (EasingFunctionBase) Ease1);
            WindowsRuntimeMarshal.AddEventHandler<EventHandler<object>>(new Func<EventHandler<object>, EventRegistrationToken>(((Timeline) storyboard).add_Completed), new Action<EventRegistrationToken>(((Timeline) storyboard).remove_Completed), (EventHandler<object>) ((_param1, _param2) =>
            {
              page %= this.snaps.Count;
              scroll.ChangeView(new double?((double) this.snaps[page]), new double?(), new float?(), true);
          ...
          else
          {
            ...
            page = 1;
            this.SetIndexBasedOnScroll((double) this.snaps[page]);
            Storyboard storyboard3 = Ani.Begin((Timeline) Ani.DoubleAni((DependencyObject) this.scrollTransform, "X", -(double) this.snapWidth / 2.0, timeShort, (EasingFunctionBase) Ease2), (Timeline) Ani.DoubleAni((DependencyObject) this, "Opacity", 0.0, timeShort));
            WindowsRuntimeMarshal.AddEventHandler<EventHandler<object>>(new Func<EventHandler<object>, EventRegistrationToken>(((Timeline) storyboard3).add_Completed), new Action<EventRegistrationToken>(((Timeline) storyboard3).remove_Completed), (EventHandler<object>) ((_param1_3, _param2_3) =>
            {
              this.scrollTransform.put_X(scroll.HorizontalOffset - (double) this.snaps[page] + (double) this.snapWidth / 2.0);
              ...
              WindowsRuntimeMarshal.AddEventHandler<EventHandler<object>>(new Func<EventHandler<object>, EventRegistrationToken>(((Timeline) storyboard4).add_Completed), new Action<EventRegistrationToken>(((Timeline) storyboard4).remove_Completed), (EventHandler<object>) ((_param1_4, _param2_4) =>
              {
                page %= this.snaps.Count;
                scroll.ChangeView(new double?((double) this.snaps[page]), new double?(), new float?(), true);
                this.scrollTransform.put_X(0.0);
    ...
    protected virtual Size ArrangeOverride(Size finalSize)
    {
      ...
      for (int index = 0; index < ((ICollection<UIElement>) this.Children).Count; ++index)
      {
        if (((IList<UIElement>) this.Children)[index] is FrameworkElement child && ((UIElement) child).Visibility != 1)
        {
    ...
    public float GetRegularSnapPoints(
      ...
      out float offset)
    {
      offset = orientation != 1 ? this.snapWidth : this.snapWidth;
      return offset;
    }

    public event EventHandler<object> HorizontalSnapPointsChanged
    {
      add => EventRegistrationTokenTable<EventHandler<object>>.GetOrCreateEventRegistrationTokenTable(ref this.HorizontalSnapPointsChanged).AddEventHandler(value);
      remove => EventRegistrationTokenTable<EventHandler<object>>.GetOrCreateEventRegistrationTokenTable(ref this.HorizontalSnapPointsChanged).RemoveEventHandler(value);
    }
