...
namespace myTube
{
  ...
  {
    public static DependencyProperty ItemHeightProperty = DependencyProperty.Register(nameof (ItemHeight), typeof (double), typeof (WrapPanel), new PropertyMetadata((object) double.NaN, new PropertyChangedCallback(WrapPanel.OnItemHeightChanged)));
    ...
    protected virtual Size ArrangeOverride(Size finalSize)
    {
      ...
      foreach (UIElement child in (IEnumerable<UIElement>) this.Children)
      {
        ...
        child.Arrange(new Rect(x, y, desiredSize.Width, double.IsNaN(this.ItemHeight) ? desiredSize.Height : this.ItemHeight));
    ...
    protected virtual Size MeasureOverride(Size availableSize)
    {
      ...
      foreach (UIElement child in (IEnumerable<UIElement>) this.Children)
      {
        child.Measure(new Size(availableSize.Width, double.IsNaN(this.ItemHeight) ? availableSize.Height : this.ItemHeight));
        Size desiredSize = child.DesiredSize;
