  ...
  public static class Settings
  {
    ...
    public static MiniPlayerType MiniPlayerType
    {
      get
      {
        try
        {
          return App.DeviceFamily == DeviceFamily.Mobile ? MiniPlayerType.Background : (MiniPlayerType) Enum.Parse(typeof (MiniPlayerType), ((IDictionary<string, object>) Settings.local.Values)[nameof (MiniPlayerType)].ToString());
        }
        catch
        {
          return App.DeviceFamily == DeviceFamily.Desktop ? MiniPlayerType.MiniPlayer : MiniPlayerType.Background;
        }
      }
      set => ((IDictionary<string, object>) Settings.local.Values)[nameof (MiniPlayerType)] = (object) value.ToString();
    }

    public static ColorSchemes ColorCheme
    {
      set => ((IDictionary<string, object>) Settings.local.Values)["ColorScheme"] = (object) value.ToString();
      get
      {
        try
        {
          ...
          if (((IDictionary<string, object>) Settings.local.Values).ContainsKey("ColorScheme"))
            return (ColorSchemes) Enum.Parse(typeof (ColorSchemes), ((IDictionary<string, object>) Settings.local.Values)["ColorScheme"].ToString());
    ...
    public static YouTubeOrder CommentsOrder
    {
      get
      {
        try
        {
          return ((IDictionary<string, object>) Settings.roaming.Values).ContainsKey(nameof (CommentsOrder)) ? (YouTubeOrder) Enum.Parse(typeof (YouTubeOrder), ((IDictionary<string, object>) Settings.roaming.Values)[nameof (CommentsOrder)].ToString()) : YouTubeOrder.Relevance;
        }
        catch
        {
      ...
      set => ((IDictionary<string, object>) Settings.roaming.Values)[nameof (CommentsOrder)] = (object) value.ToString();
    }
    ...
    public static RotationType RotationType
    {
      get
      {
        try
        {
          return App.DeviceFamily == DeviceFamily.Desktop ? RotationType.System : (RotationType) Enum.Parse(typeof (RotationType), ((IDictionary<string, object>) Settings.roaming.Values)["rotationType"].ToString());
        }
        catch
        {
          return App.DeviceFamily == DeviceFamily.Mobile ? RotationType.Custom : RotationType.System;
        }
      }
      set => ((IDictionary<string, object>) Settings.roaming.Values)["rotationType"] = (object) value.ToString();
    }

    public static double Volume
    {
      get => ((IDictionary<string, object>) Settings.local.Values).ContainsKey(nameof (Volume)) ? (double) ((IDictionary<string, object>) Settings.local.Values)[nameof (Volume)] : 1.0;
      set => ((IDictionary<string, object>) Settings.local.Values)[nameof (Volume)] = (object) value;
    }
    ...
    {
      get => ((IDictionary<string, object>) Settings.local.Values).ContainsKey(nameof (TranslationDownloadedAt)) ? (DateTimeOffset) ((IDictionary<string, object>) Settings.local.Values)[nameof (TranslationDownloadedAt)] : DateTimeOffset.MinValue;
      set => ((IDictionary<string, object>) Settings.local.Values)[nameof (TranslationDownloadedAt)] = (object) value;
    }
    ...
    public static ElementTheme Theme
    {
      get
      {
        try
        {
          return ((IDictionary<string, object>) Settings.local.Values).ContainsKey("elementTheme") ? (ElementTheme) Enum.Parse(typeof (ElementTheme), (string) ((IDictionary<string, object>) Settings.local.Values)["elementTheme"]) : (ElementTheme) 2;
        }
        catch
        {
    ...
    public static ThumbnailStyle Thunbnail
    {
      get
      {
        try
        {
          return ((IDictionary<string, object>) Settings.local.Values).ContainsKey("thumbnail") ? (ThumbnailStyle) Enum.Parse(typeof (ThumbnailStyle), (string) ((IDictionary<string, object>) Settings.local.Values)["thumbnail"]) : ThumbnailStyle.New;
        }
        catch
        {
    ...
    public static YouTubeQuality Quality
    {
      get
      {
        try
        {
          return (YouTubeQuality) Enum.Parse(typeof (YouTubeQuality), (string) ((IDictionary<string, object>) Settings.local.Values)["quality"]);
        }
        catch
        {
    ...
    {
      get => ((IDictionary<string, object>) Settings.local.Values).ContainsKey("runs") ? (int) ((IDictionary<string, object>) Settings.local.Values)["runs"] : 0;
    ...
    public static UserMode UserMode
    {
      get
      {
        try
        {
          return (UserMode) Enum.Parse(typeof (UserMode), (string) ((IDictionary<string, object>) Settings.roaming.Values)[nameof (UserMode)]);
        }
        catch
        {
      ...
      set => ((IDictionary<string, object>) Settings.roaming.Values)[nameof (UserMode)] = (object) value.ToString();
    }
    ...
    public static Version Version
    {
      get
      {
        try
        {
          return Version.Parse(((IDictionary<string, object>) Settings.local.Values)[nameof (Version)].ToString());
        }
        catch
        {
      ...
      set => ((IDictionary<string, object>) Settings.local.Values)[nameof (Version)] = (object) value.ToString();
    }
    ...
    public static DateTimeOffset BackgroundTaskLastRun
    {
      get
      {
        try
        {
          return (DateTimeOffset) ((IDictionary<string, object>) Settings.local.Values)[nameof (BackgroundTaskLastRun)];
        }
        catch
        {
          return DateTimeOffset.MinValue;
    ...
    public static PlaylistRepeatMode PlaylistRepeatMode
    {
      get
      {
        try
        {
          return (PlaylistRepeatMode) Enum.Parse(typeof (PlaylistRepeatMode), ((IDictionary<string, object>) Settings.local.Values)[nameof (PlaylistRepeatMode)].ToString());
        }
        catch
        {
      ...
      set => ((IDictionary<string, object>) Settings.local.Values)[nameof (PlaylistRepeatMode)] = (object) value.ToString();
    }
    ...
    public static AfterVideoSection AfterVideoSection
    {
      get
      {
        try
        {
          return (AfterVideoSection) Enum.Parse(typeof (AfterVideoSection), ((IDictionary<string, object>) Settings.local.Values)[nameof (AfterVideoSection)].ToString());
        }
        catch
        {
      ...
      set => ((IDictionary<string, object>) Settings.local.Values)[nameof (AfterVideoSection)] = (object) value.ToString();
    }
    ...
    public static TileStyle TileStyle
    {
      get
      {
        try
        {
          return (TileStyle) Enum.Parse(typeof (TileStyle), (string) ((IDictionary<string, object>) Settings.local.Values)[nameof (TileStyle)]);
        }
        catch
        {
      ...
      set => ((IDictionary<string, object>) Settings.local.Values)[nameof (TileStyle)] = (object) value.ToString();
    }
    ...
    public static RegionInfo Region
    {
      get
      {
        try
        {
          return RegionInfo.GetFromCode((string) ((IDictionary<string, object>) Settings.roaming.Values)[nameof (Region)]);
        }
        catch
        {
          try
          {
            return RegionInfo.GetFromCode((string) ((IDictionary<string, object>) Settings.local.Values)[nameof (Region)]);
          }
          catch
          {
      ...
      set => ((IDictionary<string, object>) Settings.roaming.Values)[nameof (Region)] = (object) value.CountryCode;
    }
    ...
    static Settings()
    {
      ...
      WindowsRuntimeMarshal.AddEventHandler<TypedEventHandler<ApplicationData, object>>(new Func<TypedEventHandler<ApplicationData, object>, EventRegistrationToken>(current.add_DataChanged), new Action<EventRegistrationToken>(current.remove_DataChanged), new TypedEventHandler<ApplicationData, object>((object) null, __methodptr(Current_DataChanged)));
    ...
    private static void Current_DataChanged(ApplicationData sender, object args) => Helper.Write((object) "Data changed");

    public static async Task<PageInfoCollection> GetPageInfoCollection()
    {
      try
      {
        return new PageInfoCollection(XElement.Parse(await FileIO.ReadTextAsync((IStorageFile) await Settings.localFolder.GetFileAsync("PageInfoCollection.xml"))));
      }
      catch
      {
    ...
    public static PageInfoCollection GetPageInfoCollection(CustomFrame frame)
    {
      ...
      if (((ContentControl) frame).Content != null)
        pageInfoCollection.AddPage(new PageInfo(frame.SourcePageType, (((ContentControl) frame).Content as FrameworkElement).DataContext));
    ...
    public static async Task SavePageInfoCollection(CustomFrame frame)
    {
      try
      {
        ...
        await FileIO.WriteTextAsync((IStorageFile) await Settings.localFolder.CreateFileAsync("PageInfoCollection.xml", (CreationCollisionOption) 1), ((object) pic.XML).ToString());
    ...
    public static class WatchLater
    {
      public static PlaylistPosition AddVideosTo
      {
        get
        {
          try
          {
            return (PlaylistPosition) Enum.Parse(typeof (PlaylistPosition), (string) ((IDictionary<string, object>) Settings.roaming.Values)["watchLaterPos"]);
          }
          catch
          {
        ...
        set => ((IDictionary<string, object>) Settings.roaming.Values)["watchLaterPos"] = (object) value.ToString();
      }
    }
    ...
    public static class Subscriptions
    {
      ...
      public static bool AllChannels
      {
        ...
        set => ((IDictionary<string, object>) Settings.Subscriptions.values)["allChannels"] = (object) value;
      }
      ...
      public static bool FilterChannels
      {
        ...
        set => ((IDictionary<string, object>) Settings.Subscriptions.values)["filterChannels"] = (object) value;
      }

      static Subscriptions()
      {
        if (((IDictionary<string, object>) Settings.Subscriptions.local.Values).ContainsKey("subscriptionData"))
          Settings.Subscriptions.values = (ApplicationDataCompositeValue) ((IDictionary<string, object>) Settings.Subscriptions.local.Values)["subscriptionData"];
        else
      ...
      private static async Task InitializeFilter()
      {
        ...
        try
        {
          Settings.Subscriptions.filters = JToken.Parse(await FileIO.ReadTextAsync((IStorageFile) await Settings.Subscriptions.localFolder.GetFileAsync("subscriptionFilters.json"))).ToObject<Dictionary<string, List<string>>>();
        }
        catch
        {
      ...
      public static async Task<List<string>> GetFilteredItems(string userChannelId)
      {
        ...
        return !Settings.Subscriptions.filters.ContainsKey(userChannelId) ? new List<string>() : new List<string>((IEnumerable<string>) Settings.Subscriptions.filters[userChannelId]);
      }

      public static async Task<bool> IsFilteredOut(string userChannelId, string subChannelId)
      {
        await Settings.Subscriptions.InitializeFilter();
        return Settings.Subscriptions.filters.ContainsKey(userChannelId) && Settings.Subscriptions.filters[userChannelId].Contains(subChannelId);
      }
      ...
      {
        ((IDictionary<string, object>) Settings.Subscriptions.local.Values)["subscriptionData"] = (object) Settings.Subscriptions.values;
        if (Settings.Subscriptions.filters == null)
          return;
        JToken token = JToken.FromObject((object) Settings.Subscriptions.filters);
        await FileIO.WriteTextAsync((IStorageFile) await Settings.Subscriptions.localFolder.CreateFileAsync("subscriptionFilters.json", (CreationCollisionOption) 1), ((object) token).ToString());
        token = (JToken) null;
      }
    }
  }
