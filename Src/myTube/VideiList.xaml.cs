    ...
    public sealed class VideoList : UserControl//, IComponentConnector
    {
        ...
        public void BeginSort()
        {
            ...
            WindowsRuntimeMarshal.AddEventHandler<EventHandler<object>>(new Func<EventHandler<object>,
                EventRegistrationToken>(((FrameworkElement)panel).add_LayoutUpdated), new Action<EventRegistrationToken>(((FrameworkElement)panel).remove_LayoutUpdated), new EventHandler<object>(this.panel_LayoutUpdated));
