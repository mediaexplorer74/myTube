...
// Type: WinRTXamlToolkit.Controls.Extensions.PasswordAutoSelectOnFocusHandler
...
namespace WinRTXamlToolkit.Controls.Extensions
{
  public class PasswordAutoSelectOnFocusHandler
  {
    ...
    public PasswordAutoSelectOnFocusHandler(PasswordBox associatedObject) => this.Attach(associatedObject);
